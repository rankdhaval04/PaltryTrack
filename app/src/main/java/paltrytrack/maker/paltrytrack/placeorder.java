...
public class placeorder extends AppCompatActivity {
    ...
    String urladdress="http://192.168.43.199/orderads.php";
    String urladdress1="http://192.168.43.199/placeorder.php";
    ...
    String dh;
    int ab;
    String name1,username,storeid,td,db;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        iv1=(ImageView) findViewById(R.id.iv2);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                collectData1();
                Toast.makeText(placeorder.this,"Item is Added in your cart",Toast.LENGTH_LONG).show();
                Intent i12=new Intent(placeorder.this,dashboard.class);//redirect to item list
                startActivity(i12);
            }
        });
...
//JSON
        try{
            ...
            for(int i=0;i<=ja.length();i++){
                ...
                //  new CustomListView.GetImageFromURL(iv1).execute(jo.getString("image_path"));
                new DownLoadImageTask(iv1).execute(jo.getString("small_pic"));
            }
        }
        catch (Exception ex)
        {
...
//Connection
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id3 == R.id.cart) {
            Intent inte=new Intent(placeorder.this,cart.class);
            startActivity(inte);
            return true;
        }
